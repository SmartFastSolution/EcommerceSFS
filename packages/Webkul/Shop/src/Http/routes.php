...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    //points
    Route::get('/points', 'Webkul\Shop\Http\Controllers\SubscriptionController@points')->name('shop.points');


    Route::get('/coming', function () {
       
        return  view('shop::errors.coming');
    });

    Route::get('/guayaquil', function () {
       
        return  view('shop::local.guayaquil');
    });
    ...
    //search product by category Tyrone
    Route::get('/search/category/{id}', 'Webkul\Shop\Http\Controllers\SearchController@byCategory')->defaults('_config', [
        'view' => 'shop::search.search'
    ])->name('shop.search.category');

    
    //search product by category Tyrone
     

   Route::get('/productallCategory/{id}', 'Webkul\Shop\Http\Controllers\ProductController@allCategoryofProduct')->defaults('_config', [
        'view' => 'shop::search.search'
    ])->name('shop.search.category2');


    //?search product by code of category JPinero
    Route::get('/search/category/code/{code}', 'Webkul\Shop\Http\Controllers\SearchController@byCategoryCode')->defaults('_config', [
        'view' => 'shop::search.search'
    ])->name('shop.search.category_code');
