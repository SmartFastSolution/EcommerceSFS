...
class CategoryRepository extends Repository
{
    ...
    {
        return $this->getModel()->orderBy('position', 'ASC')->where('parent_id', NULL)->where('status', 1)->get();
    }

    public function getChildrenCategories($id)
    {
        return $this->getModel()->orderBy('position', 'ASC')->where('parent_id', $id)->where('status', 1)->get();
    }
    /**
     * Get root categories
     *
    ...
    {
        return $this->getModel()->orderBy('position', 'ASC')->where('status', 1)->get();
    }

    public function getAllCategoriesFather()
    {
        return $this->getModel()->orderBy('position', 'ASC')->where('status', 1)->whereNull('parent_id')->get();
    }
